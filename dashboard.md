...
|---|---|
| Total prospects | 94 |
| Outreach drafted (awaiting Shane to send) | 30 |
| Contacted (sent) | 0 |
| Replied | 0 |
| Interested | 0 |
| Active partners | 0 |
...
*Batch 1 (top 10 by fit) in `outbox/2026-09-25/`; batch 2 (11–20) in `outbox/2026-09-25-batch2/`; batch 3 (21–30) in `outbox/2026-09-25-batch3/` — nothing sent yet. "Contacted" moves once Shane sends and logs it in `inbox/replies.md`.*
